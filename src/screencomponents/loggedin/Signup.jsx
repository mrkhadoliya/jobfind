        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{flex:1}}>
            ...
            <View>
                ...
                <View style={{marginVertical:10}}>
                    <TouchableOpacity style={styles.ForgotPasswordBTN} onPress={() => navigation.navigate('forget password')}>
                ...
                <View>
                    ...
                    <TouchableOpacity style={styles.LoginGoogleBtn} activeOpacity={0.7}>
                        ...
                        <Text style={{color:'#4EC133', fontSize:16, fontWeight:'600'}}>Sign-up with Google</Text>
                    </TouchableOpacity>
                </View>
                <View>
